...
```text
<CardGrid cols={1}>
  <Card title="Step 1 — Install">Run `npm create scrollup@latest my-docs` to scaffold a new site.</Card>
...
<CardGrid cols={1}>
  <Card title="Step 1 — Install">
    Run `npm create scrollup@latest my-docs` to scaffold a new site.
  </Card>
