...
<Steps>
  <Step num={1} title="Scaffold the template">
    ```sh title="Terminal"
    npm create scrollup@latest my-project-docs
    cd my-project-docs
    npm install
    ```
  </Step>
...
```sh title="Terminal"
mkdir -p content/docs/en/guides
```

Then create `content/docs/en/guides/quickstart.mdx`:

```mdx title="content/docs/en/guides/quickstart.mdx"
---
title: "Quickstart"
